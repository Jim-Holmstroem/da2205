...
\section{The dawn of new hardware}
    ...
    with that use 
    of a read-only memory which removes the problem of write?-locks , and that all the buses are separated for
    ...
    Dynamic vision sensors - asynchronous event based readout.\cite{dvs}
